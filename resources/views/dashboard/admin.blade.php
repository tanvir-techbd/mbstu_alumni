<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <x-stat-card-placeholder label="Verified Alumni" milestone="M3 — Alumni Profile + Verification" />
            <x-stat-card-placeholder label="Pending Verification" milestone="M3 — Alumni Profile + Verification" />
